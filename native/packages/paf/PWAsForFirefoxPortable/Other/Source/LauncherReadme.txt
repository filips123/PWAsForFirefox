...
user in an INI file next to PWAsForFirefoxPortable.exe called PWAsForFirefoxPortable.ini.
...
copy AppNamePortable.ini from this directory to PWAsForFirefoxPortable.ini next
to PWAsForFirefoxPortable.exe. The options in the INI file are as follows:
...
only medium. This is known as Live mode. It copies what it needs to a
