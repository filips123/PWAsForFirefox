...
dynamic-window-title =
    .label = Spreminjaj ime okna glede na ime aplikacije
dynamic-window-icon =
    .label = Spreminjaj ikono okna glede na ikono aplikacije
...
launch-type-choice-new-tab =
    .label = Odpri aplikacijo v novem zavihku
launch-type-choice-replace =
    .label = Zamenjaj obstoječi zavihek
...
shortcuts-close-tab =
    .label = Zapri zavihek ({ $shortcut })
shortcuts-close-window =
    .label = Zapri okno ({ $shortcut })
shortcuts-quit-application =
    .label = Zapri aplikacijo ({ $shortcut })
shortcuts-private-browsing =
    .label = Zasebno brskanje ({ $shortcut })
