...
toolbar-button-mute =
    .label = Preklopi zvok
    .tooltiptext = Preklopi zvok strani ({ $shortcut })
toolbar-button-reader-view =
    .label = Bralni pogled
    .tooltiptext = Preklopi bralni pogled ({ $shortcut })
toolbar-button-copy-link =
    .label = Kopiraj povezavo
    .tooltiptext = Kopiraj povezavo na to stran
toolbar-button-share-link =
    .label = Deli povezavo
    .tooltiptext = Deli povezavo na to stran
toolbar-button-send-to-device =
    .label = Pošlji na napravo
    .tooltiptext = Pošlji to stran na drugo napravo
toolbar-button-open-in-browser =
    .label = Odpri v brskalniku
    .tooltiptext = Odpri to stran v brskalniku
toolbar-button-tracking-protection =
    .label = Zaščita pred sledenjem
    .tooltiptext = Prikaži informacije o zaščiti pred sledenjem za to stran
toolbar-button-identity =
    .label = Informacije o strani
    .tooltiptext = Prikaži informacije o tej strani
toolbar-button-permissions =
    .label = Dovoljenja strani
    .tooltiptext = Prikaži dovoljenja, dodeljena tej strani
toolbar-button-notifications =
    .label = Obvestila strani
    .tooltiptext = Pojavna obvestila za to stran
toolbar-button-close =
    .label = Zapri
    .tooltiptext = Zapri trenutno stran
toolbar-button-home-ffpwa =
    .label = { navbar-home.label }
    .tooltiptext = Začetna stran aplikacije
