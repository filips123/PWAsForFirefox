...
| [Microsoft Teams](https://teams.live.com/) | Microsoft Teams's manifest specifies the scope as `/v2/`, while the protocol handler URL is set to outside the scope. Because of this, the manifest fails the required checks. As a workaround, install Microsoft Teams without the manifest enabled.                                                                                                                                                                                                                                                                                                                                                          | [#815](https://github.com/filips123/PWAsForFirefox/issues/815)                                                               |
